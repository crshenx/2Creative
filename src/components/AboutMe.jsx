...
function AboutMe() {
  return (
    <div className="about-me">
      ...
      <div className="about-me__background-wrap">
          ...
          <div className="about-me__background">
            ...
            <div className="about-me_text-container">
              <p className="about-me__text-p1">
                ...
                actually that simple. It is also where my agenda starts and
                ends. There is nothing that fills me with more joy than helping
                create a joyous moment, experience, or memory for someone. I
                adore a good story!
              </p>
              <p className="about-me__text-p2">
                So I am incredibly blessed to have the opportunity to be a part
                of my couples' love stories during one of their most special
                chapters. It is actually unreal! As your Wedding/Event Planner
                or day of Bridal Concierge, my hope is that we come out of our
              ...
              <p className="about-me__text-p3">
                ...
                grand moments you always dreamed of, along with the more quiet
                and intimate pieces of your day. I want to assist you in
                arriving at your big day, whatever it is, as your true self! I
                am fully here for you.
              </p>
