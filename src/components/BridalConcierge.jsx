      ...
      <div className="concierge__content">
        ...
        <div className="concierge__text-container">
          <div className="concierge__text-p1">
            What would it be like for a Bride to have an event planner, personal
            assistant, suedo therapist, and walking wardrobe/personal comfort
            MacGyver by her side throughout the biggest day of her life. . . ?
          </div>
          ...
          <div className="concierge__text-p3">
            ...
            day is not complete without The Original Bridal Concierge.
          </div>
          <div className="concierge__text-p4">
            Over the last decade I have worked intimately with Brides and their
            bridal parties elevating their wedding experience. I am an adept
            wedding/event professional with a background specifically in Bridal
            gown design, luxury sales and customer service, in addition to "Day
          ...
          <div className="concierge__text-p5">
            ...
            photography team and Bride with her details and family photos, and
